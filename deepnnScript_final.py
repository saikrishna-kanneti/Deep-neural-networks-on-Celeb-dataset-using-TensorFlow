...
def create_multilayer_perceptron_1():
    # Network Parameters
...
def create_multilayer_perceptron_7():
    ...
    n_hidden_2 = 256  # 2nd layer number of features
    n_hidden_3 = 256
    n_hidden_4 = 256  # 1st layer number of features
    ...
    weights = {
        ...
        'h2': tf.Variable(tf.random_normal([n_hidden_1, n_hidden_2])),
        'h3': tf.Variable(tf.random_normal([n_hidden_2, n_hidden_3])),
        'h4': tf.Variable(tf.random_normal([n_input_3, n_hidden_4])),
        'h5': tf.Variable(tf.random_normal([n_hidden_4, n_hidden_5])),
        'h6': tf.Variable(tf.random_normal([n_hidden_5, n_hidden_6])),
        'h7': tf.Variable(tf.random_normal([n_input_6, n_hidden_7])),
...
for j in layers:
    if(j==1):
        pred,x,y = create_multilayer_perceptron_1()
    if(j==3):
...
# Define loss and optimizer
    ...
    with tf.Session() as sess:
        ...
        accuracy_values.append(accuracy.eval({x: test_features, y: test_labels}))
        print("Number of hidden layers is: ",j)
